...
└── Basket/
    └── Encestando Sueños/
        ├── Sub 13/
        │   └── Encestando Sueños Sub 13/
        ├── Sub 15/
        │   └── Encestando Sueños Sub 15/
        └── Sub 17/
...
2. Usar **＋** para agregar los jugadores del equipo
3. Para instalar como PWA: Safari → Compartir → Agregar a pantalla de inicio
